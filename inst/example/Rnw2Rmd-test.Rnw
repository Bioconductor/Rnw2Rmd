...
The \CRANpkg{knitr} is used to create \textbf{markdown} vignettes.
...
\software{samtools} is pretty \textit{important} in Bioinformatics...
...
Here's some \emph{italic} text

Here's an Sexpr that should be evaluated \Sexpr{1 + 1}
